    ...
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          <h2 class="card_title">Registra un Nuevo proveedor</h2>
          <p class="card_text">En esta seccion podras añadir un nuevo producto a tu inventario :</p>
          <a href="regis_prov.php" class="btn card_btn">Vea mas aqui!</a>  
        </div>
      </div>
    </li>
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          <h2 class="card_title">Consulta , Actualiza y Elimina un registro de un proveedor</h2>
          <p class="card_text">En esta seccion podras consultar los productos que tienes en tu inventario:</p>
          <a href="consul_prov.php" class="btn card_btn">Vea más aquí!</a>
        </div>
      </div>
    </li>
  </ul>
